      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-gray-800 rounded-lg shadow-xl p-8 space-y-6">
          ...
          <div className="mt-8 space-y-4">
            <h2 className="text-2xl font-bold text-[#ffdbbb] font-[family-name:var(--font-eb-garamond)]">
              Key Features
            </h2>
            <ul className="list-disc list-inside space-y-2 text-[#ffdbbb] font-[family-name:var(--font-eb-garamond)]">
