export const ModalStyles = {
  ...
  modal:
    "bg-gray-800/90 rounded-xl shadow-xl w-full max-w-md mx-auto p-6 border border-gray-700 font-(family-name:--font-eb-garamond)",
  header: "flex justify-center items-center mb-6",
  title:
    "text-2xl font-bold text-[#ffdbbb] font-(family-name:--font-eb-garamond) text-center",
