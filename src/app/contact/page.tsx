        ...
        <div className="bg-gray-800 rounded-lg shadow-xl p-8 space-y-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div>
                <h2 className="text-xl font-bold text-[#ffdbbb] mb-2 font-(family-name:--font-eb-garamond)">
                  Get in Touch
                </h2>
                <p className="text-[#ffdbbb] font-(family-name:--font-eb-garamond)">
          ...
          <div className="pt-6 border-t border-gray-700">
            <p className="text-gray-400 text-center font-(family-name:--font-eb-garamond)">
