    ...
    <div className="min-h-screen bg-gray-900 p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-400 mb-8 font-(family-name:--font-eb-garamond)">
          Select your user type and fill out the information below to complete
          your profile.
        </p>
            ...
            {selectedType && (
              <p className="text-gray-400 text-sm mt-1 font-(family-name:--font-eb-garamond)">
                {selectedType === "resident" &&
                  "You are a resident who may need assistance during emergencies"}
                {selectedType === "dispatcher" &&
                  "You work at a dispatch center and coordinate emergency responses"}
                {selectedType === "first_responder" &&
                  "You are an EMT, firefighter, police officer, or other emergency responder"}
              </p>
            )}
          </div>
            ...
            <>
              ...
              {selectedType === "resident" && (
                <>
                  ...
                  <div>
                    <label className={labelClasses}>Medical Needs</label>
                    <textarea
                      name="medical_needs"
                      rows={3}
                      className={inputClasses}
